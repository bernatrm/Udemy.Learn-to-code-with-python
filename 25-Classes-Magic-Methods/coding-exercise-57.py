...
class Newspaper():
    def __init__(self, pages: int, sections: dict) -> None:
        self.pages = pages
    ...
    def __getitem__(self, index):
        return self.sections[index] # returns the value of this key in the dict

    def __eq__(self, other_newspaper: object) -> bool:
