...
print(isinstance([], (list, dict, int))) # True if type match with anyone

# isinstance is not a good practice, you should pay attention on what an object can do, not on which kind of object is
